...
const checks = [
  ...
  ["unit", ["test"]],
  ["claude-guard", ["exec", "--", "vitest", "run", "tests/guard-claude-tool.test.mjs"]],
  ["workflow", ["exec", "--", "vitest", "run", "tests/workflow-contract.test.mjs", "tests/workflow-e2e.test.mjs", "tests/workflow-gate.test.mjs"]],
