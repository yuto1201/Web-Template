---
name: change-evaluator-openai
description: "Read-only exact-Head change evaluator using the configured OpenAI family. Use after verification for the family slot required by repository risk policy."
