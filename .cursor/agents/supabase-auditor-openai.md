---
name: supabase-auditor-openai
description: "Read-only Supabase auditor using the configured OpenAI family. Use after verification for the family slot required by repository risk policy."
